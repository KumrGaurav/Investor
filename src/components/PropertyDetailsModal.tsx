...
const PropertyDetails: React.FC<PropertyDetailsProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For demo purposes, we'll randomly decide if it succeeds
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    className="border rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
